...
import Graphics.Element exposing (Element, container, flow, down, spacer, height, heightOf, width, color)
import Graphics.Element exposing (midLeftAt, midTop, midTopAt, absolute)
...
generatePost (w,h) t postBody = let bodyHeight = heightOf (width 500 postBody)
                                ...
                                in flow down [ titlebar w <| Fmt.title "  CF",
                                               ...
                                               container w titleHeight midTop (Fmt.formatTitleText t) |> height 160,                             
