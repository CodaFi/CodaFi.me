...
Elm.Website.Blog.Formatting.make = function (_elm) {
   ...
   var formatFunctionText = function (s) {
      return $Graphics$Element.justified($Text.height(36)($Text.typeface(_L.fromArray(["Computer Modern Roman"]))($Text.fromString(s))));
   };
   var formatTitleText = function (s) {
      return $Graphics$Element.justified($Text.color(A3($Color.rgb,
      94,
      94,
      93))($Text.height(36)($Text.typeface(_L.fromArray(["Helvetica-Bold"]))($Text.fromString(s)))));
   };
   var titleStyle = {_: {}
                    ,bold: true
                    ,color: A3($Color.rgb,
